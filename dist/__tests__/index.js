...
var _require = require('../index'),
    ...
    numbersRule = _require.numbersRule;

var _require2 = require('../index'),
    colorsMessages = _require2.colorsMessages,
    colorsRuleName = _require2.colorsRuleName,
    colorsRule = _require2.colorsRule;

testRule({
  rule: numbersRule,
  ruleName: numbersRuleName,
  config: [true, {
    acceptedNumbers: [0, 1, 2, 3],
    acceptedValues: ['100%', '25%']
  }],
  accept: [{
